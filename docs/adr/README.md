...
Accepted ADRs for RootSync. Format: [ADR_GUIDELINES.md](../governance/ADR_GUIDELINES.md).

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-001](./ADR-001-offering-listing-model.md) | Offering and Listing Model | Accepted |
...
| [ADR-009](./ADR-009-guest-service-bookings.md) | Guest Service Bookings (no account required) | Accepted |
| [ADR-010](./ADR-010-donation-listing-type.md) | Donation Listing Type | Accepted |
